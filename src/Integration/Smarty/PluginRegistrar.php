...
/**
 * Register all XOOPS Helpers Smarty plugins at once.
 *
 * Usage in module bootstrap or theme setup:
 *   PluginRegistrar::register($smarty);
 */
final class PluginRegistrar
{
    /**
     * Register all helper Smarty plugins.
     */
